  ...
  head: () => ({
    meta: [
      { title: "Beleza Dedicada | Cursos de Cortes Profissionais" },
      {
        name: "description",
        content:
          "16 cursos de corte + certificado + acesso vitalício. Escolha o plano ideal a partir de R$ 29,90.",
      },
      { property: "og:title", content: "Beleza Dedicada | Cursos de Cortes Profissionais" },
      { property: "og:description", content: "16 cursos de corte + certificado + acesso vitalício. A partir de R$ 29,90." },
      { property: "og:url", content: "https://belezadedicada.com" },
    ...
    links: [
      { rel: "canonical", href: "https://belezadedicada.com" },
    ],
  }),
});
